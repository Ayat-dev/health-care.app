-- Paiement mobile par QR marchand (AmanaTa / MyNITA) — confirmation manuelle.
...
ALTER TABLE clinic_config ADD COLUMN amanata_qr_url VARCHAR(255);
ALTER TABLE clinic_config ADD COLUMN amanata_merchant_id VARCHAR(60);
