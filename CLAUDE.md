...
> **👉 NEXT UP:** Wave 2 — module 8 Lab (09): `lab_requests` → consultations + `lab_test_catalog`. Mirror the "exam request → result" pattern; the `lab_test_catalog` reference table already exists (V4). This pattern will be factored/shared with module 9 Radiology.
