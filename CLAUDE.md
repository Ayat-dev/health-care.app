...
### 🚀 Wave 4 — Continuous
- [x] **15. Deployment** (15) — docker-compose.yml done · monitoring done (P4.3: Actuator + Prometheus/Grafana sous profil compose `monitoring`, sonde `/actuator/health` publique pour UptimeRobot) · TODO (ongoing): harden Flyway, backups, .env, audit trail
